...
CATALOG_SEED = [
    ...
    # --- More native-Linux dedicated servers (Unreal / bespoke) ---
    {"key": "humanitz", "name": "HumanitZ", "steam_app_id": 2728330,
     "start_cmd": "./HumanitZServer-Linux-Shipping",
     "start_args": "-log -steamservername=Portal", "game_port": 7777,
     "config_paths": ["*/Saved/Config/LinuxServer/*.ini", "*.json"],
     "backup_paths": ["*/Saved/SaveGames/**"]},
    {"key": "smalland", "name": "Smalland: Survive the Wilds", "steam_app_id": 808040,
     "start_cmd": "./SMALLANDServer.sh", "start_args": "", "game_port": 7777,
     "config_paths": ["*/Saved/Config/LinuxServer/*.ini"],
     "backup_paths": ["*/Saved/SaveGames/**"],
     "notes": "Configured from launch arguments — set them with the Options button."},
    {"key": "frozen-flame", "name": "Frozen Flame", "steam_app_id": 1348640,
     "start_cmd": "./FrozenFlameServer.sh", "start_args": "", "game_port": 7777,
     "config_paths": ["*.ini", "*.json", "*/Saved/Config/LinuxServer/*.ini"],
     "backup_paths": ["Saved/**", "**/*.db"]},
    {"key": "day-of-dragons", "name": "Day of Dragons", "steam_app_id": 1088320,
     "start_cmd": "./DragonsServer-Linux-Shipping",
     "start_args": "-SteamServerName=Portal -log", "game_port": 7777,
     "config_paths": ["*/Saved/Config/LinuxServer/*.ini"]},
    {"key": "hypercharge-unboxed", "name": "HYPERCHARGE: Unboxed",
     "steam_app_id": 1045940, "start_cmd": "./UnboxedServer-Linux-Shipping",
     "start_args": "KidsBedroom?MaxPlayers=8 -ServerName=Portal -Port=7777 -QueryPort=27015",
     "game_port": 7777, "config_paths": ["*/Saved/Config/LinuxServer/*.ini"]},
    {"key": "survive-the-nights", "name": "Survive the Nights", "steam_app_id": 1502300,
     "start_cmd": "./Server_Linux_x64", "start_args": "-mc 24 -r us",
     "game_port": 7350, "config_paths": ["*.cfg", "*.ini", "*.json"]},
    {"key": "onset", "name": "Onset", "steam_app_id": 1204170,
     "start_cmd": "./OnsetServer", "start_args": "--config server_config.json",
     "game_port": 7777, "config_paths": ["server_config.json", "*.json"]},

    # --- Free Source-engine (srcds) dedicated servers ---
    {"key": "military-conflict-vietnam", "name": "Military Conflict: Vietnam",
     "steam_app_id": 1136190, "start_cmd": "./srcds_run_x64",
     "start_args": "-game vietnam +map mcv_siege -maxplayers_override 32 +sv_lan 0",
     "game_port": 27015, "config_paths": ["vietnam/cfg/*.cfg"],
     "notes": "Free-to-play — 'anonymous' SteamCMD login works."},
    {"key": "brainbread2", "name": "BrainBread 2", "steam_app_id": 475370,
     "start_cmd": "./srcds_run",
     "start_args": "-game brainbread2 +map bba_barracks +maxplayers 20",
     "game_port": 27015, "config_paths": ["brainbread2/cfg/*.cfg"]},
    {"key": "pvkii", "name": "Pirates, Vikings, & Knights II", "steam_app_id": 17575,
     "start_cmd": "./srcds_run",
     "start_args": "-game pvkii +map bt_island +maxplayers 24",
     "game_port": 27015, "config_paths": ["pvkii/cfg/*.cfg"]},
    {"key": "nuclear-dawn", "name": "Nuclear Dawn", "steam_app_id": 111710,
     "start_cmd": "./srcds_run",
     "start_args": "-game nucleardawn +map hydro +maxplayers 32",
     "game_port": 27015, "config_paths": ["nucleardawn/cfg/*.cfg"]},
]
